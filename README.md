...
| `PUBLIC_URL`              | _(unset)_      | Canonical origin (`https://tresorpost.ch`). Share/delete links are minted here. Target of `SHORT_DOMAIN` redirects; share emails must use this host. |
